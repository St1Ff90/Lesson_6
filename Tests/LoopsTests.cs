...
namespace ProjTests
{
    class LoopsTests
    {
        ...
        {
            double actualResult = ProjLibrary.Loops.RiseToThePower(num, degree);
        ...
        public void RisetoThePower_WhenNumOrDegreeIsZero_ShoudThrowArgumentException(double num, int degree)
        {
            try
            {
                ProjLibrary.Loops.RiseToThePower(num, degree);
        ...
        {
            int[] actualResult = ProjLibrary.Loops.RoundDigits(devider);
            Assert.AreEqual(expectedResult, actualResult);
        }
        ...
        public void RoundDigits_WhenDeviderIsZero_ShouldThrowDivideByZeroException(int devider)
        {
            try
            {
                ProjLibrary.Loops.RoundDigits(devider);
            }
        ...
        {
            int actualResult = ProjLibrary.Loops.TotalCountOfPositiveDigits(maxNum);
        ...
        public void TotalCountOfPositiveDigits_WhenNumIsZeroOrLessZero_ShouldThrowArgumentException(int maxNum)
        {
            try
            {
                ProjLibrary.Loops.TotalCountOfPositiveDigits(maxNum);
            }
            catch (ArgumentException ex)
            {
